...
$havPermission = !isset($useraccess['devicesettings']['kitstatus']['delete']) ? false : $useraccess['devicesettings']['kitstatus']['delete'];
if(!$havPermission){
    echo res(false,"You Do not have Permission to Delete Device Kits",[],401);
    exit;
}
//check
