...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Device Charger Types</h4>
            
        </div>
        <div class="page-btn" >
            <button ng-show="newchargemodelacces" type="button" class="btn btn-added" ng-click="addnewchargertype()"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add New</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
...
<?php 
    include_once './chargertype-dia.php';
?>
