...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            ...
            <h6>Manage Product Conditions</h6>
        </div>
        <div class="page-btn" >
            <button ng-show="haveaccessnewcondition" type="button" class="btn btn-added" ng-click="addnewcondtions()"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add New</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
...
<?php 
    include_once './condition-dia.php';
?>