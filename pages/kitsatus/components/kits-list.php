...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Device Kits Status</h4>
            <h6>Manage Kits Status</h6>
        </div>
        <div class="page-btn" >
            <button ng-show="haveAccessKitstatusNew" type="button" class="btn btn-added" ng-click="addnewkits()"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add Product</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
