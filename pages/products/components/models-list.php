...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn" >
            <button ng-show="haveAccessnewmodel" type="button" class="btn btn-added" ng-click="addnewdevice()"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add Product</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
