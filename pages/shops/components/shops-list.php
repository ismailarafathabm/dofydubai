...
<div class="content">
    <div class="page-header">
        ...
        <div class="page-btn" >
            <button ng-if="haveAccessAddNewShop" type="button" class="btn btn-added" ng-click="addnewshop()"><img src="assets/img/icons/plus.svg" alt="img" class="me-1" >Add Shop</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
